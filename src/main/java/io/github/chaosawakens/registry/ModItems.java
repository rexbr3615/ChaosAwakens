...
import io.github.chaosawakens.items.GenericFood;
import io.github.chaosawakens.items.GenericItem;
import io.github.chaosawakens.items.ItemGenericSlab;
...
public class ModItems
{
	...
	//Item blocks
	public static final Item DRUID_SLAB = new ItemGenericSlab(ModBlocks.DRUID_BARK_SLAB, ModBlocks.DRUID_BARK_SLAB, ModBlocks.DRUID_BARK_SLAB_DOUBLE);
	...
	public static final Item C0RR4P1T = new GenericItem("corrupt");
	...
	//public static final Item ULTIMATIUM = new GenericItem("ultimatium", 16);
	
	//Food
	public static final Item BLT = new GenericFood("blt", 6, 0.5f, false);
	public static final Item CHEESE = new GenericFood("cheese", 3, 0.2f, true);
	public static final Item COOKED_BACON = new GenericFood("cooked_bacon", 7, 0.8f, true);
	public static final Item RAW_BACON = new GenericFood("raw_bacon", 2, 0.1f, true);
	public static final Item COOKED_CORNDOG = new GenericFood("cooked_corndog", 6, 0.4f, true);
	public static final Item RAW_CORNDOG = new GenericFood("raw_corndog", 1, 0.0f, true);
	public static final Item CORN = new GenericFood("corn", 4, 0.3f, false);
	public static final Item LETTUCE = new GenericFood("lettuce", 2, 0.1f, false);
	public static final Item TOMATO = new GenericFood("tomato", 3, 0.3f, false);
	...
	*/
	...
	//Lapis set
	public static final ItemArmor LAPIS_HELMET = new GenericArmor("lapis_helmet", ArmorMaterials.LAPIS.getArmorMaterial(), 1, EntityEquipmentSlot.HEAD);
	public static final ItemArmor LAPIS_CHESTPLATE = new GenericArmor("lapis_chestplate", ArmorMaterials.LAPIS.getArmorMaterial(), 1, EntityEquipmentSlot.CHEST);
	public static final ItemArmor LAPIS_LEGGINGS = new GenericArmor("lapis_leggings", ArmorMaterials.LAPIS.getArmorMaterial(), 2, EntityEquipmentSlot.LEGS);
	public static final ItemArmor LAPIS_BOOTS = new GenericArmor("lapis_boots", ArmorMaterials.LAPIS.getArmorMaterial(), 1, EntityEquipmentSlot.FEET);
