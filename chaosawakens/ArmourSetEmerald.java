...
public class ArmourSetEmerald extends ItemArmor{
	...
	public String getArmorTexture(ItemStack stack, Entity entity, int slot, int layer) {
		...
		if(stack.toString().contains("Leggings")) if(itemID == chaosawakens.ChaosAwakens.EMERALD_LEGGINGS.itemID)
				{
			return "chaosawakens:" + nametoadd + "_2.png";
				}
	...
	public void registerIcons (IconRegister par1iconRegister)
	{
		if (itemID == ChaosAwakens.EMERALD_HELMET.itemID) {
			itemIcon = par1iconRegister.registerIcon("chaosawakens:emerald_helmet");
		}
if (itemID == ChaosAwakens.EMERALD_CHESTPLATE.itemID) {
	itemIcon = par1iconRegister.registerIcon("chaosawakens:emerald_chestplate");

		}
if (itemID == ChaosAwakens.EMERALD_LEGGINGS.itemID) {
	itemIcon = par1iconRegister.registerIcon("chaosawakens:emerald_leggings");

}
if (itemID == ChaosAwakens.EMERALD_BOOTS.itemID) {
	itemIcon = par1iconRegister.registerIcon("chaosawakens:emerald_boots");
