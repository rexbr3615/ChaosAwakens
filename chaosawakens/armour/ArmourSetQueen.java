...
public class ArmourSetQueen extends ItemArmor{
	...
	public String getArmorTexture(ItemStack stack, Entity entity, int slot, int layer) {
		...
		if(stack.toString().contains("Leggings")) if(itemID == chaosawakens.ChaosAwakens.QUEEN_SCALE_LEGGINGS.itemID)
				{
			return "chaosawakens:" + nametoadd + "_2.png";
				}
	...
	{
		if (itemID == ChaosAwakens.QUEEN_SCALE_HELMET.itemID) {
			itemIcon = par1iconRegister.registerIcon("chaosawakens:queen_scale_helmet");
		}
if (itemID == ChaosAwakens.QUEEN_SCALE_CHESTPLATE.itemID) {
	itemIcon = par1iconRegister.registerIcon("chaosawakens:queen_scale_chestplate");

		}
if (itemID == ChaosAwakens.QUEEN_SCALE_LEGGINGS.itemID) {
	itemIcon = par1iconRegister.registerIcon("chaosawakens:queen_scale_leggings");

}
if (itemID == ChaosAwakens.QUEEN_SCALE_BOOTS.itemID) {
	itemIcon = par1iconRegister.registerIcon("chaosawakens:queen_scale_boots");
